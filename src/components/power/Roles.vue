<template>
  <div>
      ...
      <el-table :data="rolelist" border stripe>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-row :class="['roles_bottom_border',index1===0?'roles_top_border':'','row_style_center'] "
              ...
              <!-- 渲染二三级权限 -->
              <el-col :span="19">
                <el-row :class="[index2 ===0? '':'roles_top_border','row_style_center']"
    ...
    <!-- 分配权限对话框 -->
    <el-dialog title="提示" :visible.sync="setRightDialogVisible" width="45%" @close="setRightDialogClosed">
