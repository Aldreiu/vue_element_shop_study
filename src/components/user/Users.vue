<template>
  <div>
      ...
      <el-table :data="userlist" border stripe style="width: 100%">
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.mg_state" inactive-color="#ff4949">
            </el-switch>
          </template>
        </el-table-column>
        <el-table-column label="操作" width="175px">
          <template slot-scope="scope">
            ...
            <el-tooltip class="item" effect="dark" content="设置用户权限" placement="top-start" :enterable="false">
    ...
    <!-- 添加用户对话框 -->
    <el-dialog title="提示" :visible.sync="addDialogVisible" width="40%" @close="addDialogClose">
    ...
    <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="40%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRules" label-width="100px">
